...
public class UserContext {
    ...
    private RequestContext request_context = null;
    ...
    private UserContext(RequestContext _request_context, String dataID, String account, String name, String nickName, String category, String remoteIP, JsonObject extenObj) {
        request_context = _request_context;
        initUserContext(request_context.getRequest().getSession(), dataID, account, name, nickName, category, remoteIP, extenObj);
    }
    ...
    private String getIpFromRequest() {
        HttpServletRequest request = request_context.getRequest();
    ...
    public static class Builder {
        ...
        public UserContext.Builder setAsyncActionContext(RequestContext _request_context) {
            request_context = _request_context;
            return this;
        }
        ...
        public UserContext build() {
            if(null == request_context && null == session) {
                try {
            ...
            if(null == request_context) {
                ...
                return new UserContext(request_context, dataID, account, name, nickName, category, remoteIP, extenObj);
            }
        }
    }
