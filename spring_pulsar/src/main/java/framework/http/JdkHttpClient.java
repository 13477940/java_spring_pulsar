...
public class JdkHttpClient {
    ...
    public static class Builder {
        ...
        public Builder setHeaders(LinkedHashMap<String, String> headers) {
        ...
        public Builder setHeaders(JsonObject headers) {
            LinkedHashMap<String, String> map = new LinkedHashMap<>();
        ...
        public Builder setParameters(LinkedHashMap<String, String> parameters) {
            LinkedHashMap<String, String> map = new LinkedHashMap<>();
        ...
        public Builder setFiles(LinkedHashMap<String, File> files) {
        ...
        public Builder setFiles(HashMap<String, File> files) {
            LinkedHashMap<String, File> map = new LinkedHashMap<>();
            for(Map.Entry<String, File> entry : files.entrySet()) {
                String key = entry.getKey();
                File value = entry.getValue();
         ...
         */
        public Builder setAlwaysDownload(Boolean alwaysDownload) {
         ...
         */
        public Builder setTempFileDelete(Boolean deleteOnExit) {
         ...
         * 設定下載檔案的暫存資料夾路徑
         */
        public Builder setTempDirPath(String tempDirPath) {
            this.tempDirPath = tempDirPath;
            return this;
        }
         ...
         * 設定下載檔案的暫存資料夾名稱
         */
        public Builder setTempDirName(String tempDirName) {
         ...
         */
        public Builder setInsecureHttps(Boolean insecure_https) {
         ...
         */
        public Builder setResponseEncoding(String charsets_name) {
            this.resp_encoding = charsets_name;
            return this;
        }

        public Builder setKeepUrlParams(Boolean isKeepUrlParams) {
