...
public class AppSetting {
    ...
    private AppSetting(String configDirName, String configFileName, String baseFileDirName, PathContext pathContext) {
        {
    ...
    public static class Builder {
        ...
        private PathContext pathContext = null;
        private String baseFileDirPath = null;

        public Builder() {}

        public Builder setConfigDirName(String configDirName) {
            this.configDirName = configDirName;
            return this;
        }
        ...
        public Builder setBaseFileDirName(String appFileDirName) {
        ...
        public Builder setBaseFileDirPath(String baseFileDirPath) {
        ...
        public AppSetting build() {
            ...
            // check base dir path
            {
                ...
                if(null != baseFileDir && baseFileDir.exists()) {
                    ...
                    this.pathContext = new PathContext(baseFileDirPath, this.appName, System.getProperty("file.separator"));
                } else {
